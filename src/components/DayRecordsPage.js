...
const DayRecordsPage = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Use the service to fetch records for the specific date
            ...
            <button 
              onClick={async () => {
                ...
                try {
                  ...
                  const generateResponse = await fetch('https://sunny-b.onrender.com/inventory-records/generate-missing', {
                    method: 'POST',
